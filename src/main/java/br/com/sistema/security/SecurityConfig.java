...
public class SecurityConfig {
	...
	public CorsConfigurationSource corsConfigurationSource() {
	    ...
	    configuration.setAllowedOrigins(Arrays.asList("http://localhost:4200", "https://frontend-syscadastro.vercel.app")); 	// Permite a origem da sua aplicação Angular
	    ...
	    return http
	            ...
	            .authorizeHttpRequests(authorizeHttpRequests -> authorizeHttpRequests
	                    .requestMatchers(
	                            		...
	                            		"/swagger-ui/**",
	                            		"/api-docs/**"
	                            		 ).permitAll() 				// Permite acesso público ao endpoint de login e ao swagger
