...
@Service
public class TokenServiceBkp {

	private Logger logger = Logger.getLogger(TokenServiceBkp.class.getName());
	...
	private String gerarAccessToken(String username, List<String> roles, Date dataGeracaoToken, Date validadeToken) { 
	    ...
	    return JWT.create()
	            ...
	            .withIssuedAt(dataGeracaoToken)									// Define a data de emissão do token
	            .withNotBefore(dataGeracaoToken)								// garante que pode ser usado imediatamente
	            .withExpiresAt(validadeToken) 									// Define a validade do token
